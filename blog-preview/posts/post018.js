...
export default
  {
    ...
    textBlocks: [
        ...
        {type: "p", text: `仕事終わり、『鉄コン筋クリート』を観るために池袋HUMAXシネマズに向かった。沢田という、不感症で少し離れた場所から物事を見つめる男が出てくる。私にも近い部分があって、同時に私のダサい部分を突かれた気がして気分は大変だった。映画は面白かったけどまだわからなくて、帰りは雨が降っていたけど、小雨だから傘は差さなかった。`},

        {type: "p", text: `普段はパソコンの前に座って、SpotifyでPodcastを聴きながら複数のグラフィックソフトを操作する。打ち合わせをして、撮影に立ち会い、それからときどき水かお茶か、調子がよい時は紙コップで出てくる自販機でカフェモカを買って飲む。帰りは電車だけど、心地よい風が吹いている日は最寄りの一駅前で降りて家まで歩いたりする。金曜日の夜はたまに友人と集合し、ご飯を食べて、夜遅くまで営業している古着屋を見たりして、バーとかクラブに行ってみたいよねとか話して、でも結局行かなくて、サーティワンで季節限定のフレーバーを食べたりする。東京のことを全然知らないと思う。盛岡で過ごしていたときの私が、東京の暮らしはどう？と羨望のまなざしで問いかけてきて、それにすぐ答えられないけど、当時宇多田ヒカルの『Fantome』を聴いていたこと、それに「It's a lonely road But I'm not alone そんな気分」だと歌っていることを思い出して、ほんと。ほんと？本当にそうなのか？と思ったりする。`},

        {type: "p", text: `最近はもう涼しくて、これから暑い夏がやってくると思うと鬱屈な気持ちになるけど、寒い日より落ち込まないからまだマシなはずだ。それをたしかめるためにまた歩いて帰ろうと思う。Tシャツが肌に張り付くくらい湿っていた。傘を差せばよかった。`, class: ["large-space-2"]},
        ...
        {type: "p", text: `低気圧のせいか疲れている。早めに帰って、猫にごはんをあげて、トイレを掃除する。リビングのソファでうとうとしていると、猫がそろりと膝の上に乗ってくる。このまま目を瞑ってしまうと寝てしまう気がする。いけない、と思い「ごめんね」と猫をソファに移動させる。米を研ぎ、土鍋で炊く。家族の中で一番美味しく米を炊くことができる。夕飯を済ませ、湯船に浸かり、スキンケアを終わらせてから歯を磨く。右上奥歯から一本ずつ手前に向かって磨く。舌を軽く磨き、最後にフロスをする。弟に「磨きすぎだと思う。だから知覚過敏になるんじゃん。」と注意される。何回目の注意だろう。いつも10分以上は磨いているらしい。`},

        {type: "p", text: `小4から中1まで、1時間に1回石鹸で手を洗わないと気が済まなかったことを思い出す。いつも通り授業終わりに手を洗っていたら、クラスメイトに「新っていつも手洗ってるよね（笑）」と言われて、そこではじめて、1時間に1回手を洗うことが変わっていることだと知った。`},
    ...
    postHyperlinks: [
        { word: "鉄コン筋クリート", href: "https://filmaga.filmarks.com/articles/331118/" },
        { word: "池袋HUMAXシネマズ", href: "https://maps.app.goo.gl/64iwDupzsKHp76ZD6" },
        { word: "カフェモカ", href: "https://detail.chiebukuro.yahoo.co.jp/qa/question_detail/q12264296707" },
        { word: "Fantome", href: "https://www.utadahikaru.jp/music/b90wfz--ol5/" },
        { word: "It's a lonely road But I'm not alone そんな気分", href: "https://youtu.be/dUs28xUmX9I?si=Kx_97tstHDBU5-gt" },
        { word: "アンカーポイント", href: "https://share.google/aimode/cyVUxsdASns8jMFr9" },
        { word: "石鹸", href: "https://www.kaneyo.com/products/detail/125" },
        { word: "タッパー", href: "https://www.asahi-kasei.co.jp/saran/products/ziploc/container.html#gsc.tab=0" },
    ],
