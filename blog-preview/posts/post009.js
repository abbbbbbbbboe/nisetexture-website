...
export default
  {
    ...
    textBlocks: [
        ...
        {type: "p", text: `友人が突然、海外留学を考えていると話し始めた。似合うと思った。たぶん向こうでも友達ができて、私の知らない街を好きになって、憶えた言葉で泣いたり笑ったりするのだろう。そうあってほしいと思う。少し寂しくなった。誰かの未来を願いながら、その未来に私がいないかもしれないと思うと涙が溢れそうになるのは、まだ若いからだろうか。コーヒーゼリーの上で、食べられるのを静かに待っていたソフトクリームはもう、渦巻きのかたちを失いかけていた。`},
        {type: "p", text: `「そろそろ解散しよっか。今日もありがとう。」そうして店を出ると、さっきまで窓越しに見ていた渋谷への気持ちはどこにいったのか、行き交う人の多さに苛立ちながら歩いていることに気がつく。街に対する気持ちも、案外ひとつではないらしい。慈しみと憎しみ、願いと寂しさ、誰もが抱えるコントラストにくらくらする。それでも私はもう少し、東京にいると思う。星の見えない渋谷の空に、親しげな視線を投げた。`, class: ["large-space-2"]},
