...
export default
  {
    ...
    textBlocks: [
        ...
        {type: "p", text: `こういう作業ってデジタルでのデータビジュアライズ表現と相性が良いだろうとは頭では思うのだけど、ぽちぽちとアナログな感じで線を引いていく。マッピングをしている時点で既にビジュアライズなのはさておき。`, class: ["large-space-1"]},
        ...
        {type: "img-button", targetId: "1", class: ["large-space-1"]},
        ...
        {type: "p", text: `ちなみに、編集の語源はばらばらな資料をまとめることだったり、英語のeditだと、ラテン語の「外に出す」という言葉からきているようで、そこには出版の意味合いもありそう。`, class: ["large-space-1"]},
        {type: "h1", text: `次回について`},
        ...
        {type: "img-button", label: "書き込みを入れた", targetId: "2", class: ["large-space-1"]},
        {type: "h1", text: `参考文献`},
