...
export default
  {
    ...
    textBlocks: [
        ...
        { type: "a", text: `マップ1（PDF）`, link: "https://drive.google.com/file/d/1g4T34q4tsqLAFC_rYo0Z9L7FjzCuxtyn/view?usp=drive_link", class: ["link-list"] },
        ...
        {type: "p", text: `いい編集を知りたい！ということではなく、編集というキーワードからつながっていくものがあるかもしれない？という期待と、意図的になることへの解像度がもう少し欲しいという感じだろうか。もちろんいい編集ができるようになることは素晴らしいことだけど。`, class: ["large-space-1"]},
        ...
        {type: "p", text: `確かに編集をするためには編集をする対象が必要だ。そのための手法の一つとして傾聴や観察があるということか。`, class: ["large-space-1"]},
        ...
        { type: "a", text: `マップ2（PDF）`, link: "https://drive.google.com/file/d/1TvPerf4Vzgw0hS11YwIHrv2BF867KMBk/view?usp=drive_link", class: ["link-list"] },
         {type: "img-button", label: "マップ2:マップに書き込みを入れる", targetId: "2"},
        ...
        {type: "p", text: `図：小林玲衣奈`, class: ["footnote"]},
        { type: "divider" },
