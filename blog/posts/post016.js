...
export default
  {
    ...
    textBlocks: [
        ...
        {type: "p", text: `「電話」が気になっているのは、以前に瀬戸市を散歩していたときに見つけた「テレフォン法話」が面白いと思ったというのもある。特定の番号にかけると、あらかじめ録音されていた法話が聞ける。法話は当番制で、毎月担当の住職が替わる。録音に電話番号でアクセスしておおよそ3分の説法を聞く。配信とかではなく、電話なのがなんだか面白い。わざわざその番号にかけるという一手間が引き立っているような気がしている。URLにアクセスするのと本当は変わらないのかもしれないけれど。`, class: ["large-space-2"]},
        ...
        {type: "p", text: `少し脱線するのだが、発見のうちのひとつだったのは、風景は過去形であるということ。展覧会タイトルの「Scenes Passed By」を見て確かにそうだと思った。だからなにか、と言われると難しいが、自分の中で時間軸の存在がはっきり刺さったような衝撃だった。時間、過去について探ってみたいと思うし、前回触れた、自分の中の偏りや自分自身が価値付けてしまうことへの恐れについても現代思想などを参照して理論で補強してみたいと思う。実経験からゆっくり繋げていく。`, class: ["large-space-2"]},
