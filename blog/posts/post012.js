...
export default
  {
    ...
    textBlocks: [
      ...
      {type: "p", text: `《Sound Traces》は、スマホで自分の位置情報を記録しながら、同時に周囲の音を録音するプラットフォームであり、流動的なフィールド録音を蓄積していく試みです。`},
      ...
      {type: "a", text: `前林明次「閉じたループの外へ」、『OS10：ICCオープン・スペース10年の記録 2006–2015』、NTTインターコミュニケーション・センター［ICC］ （2026年4月25日閲覧）`, link: "https://www.ntticc.or.jp/ja/feature/os10/2009/#a-piece-for-metronome-andanechoic-room_column", prefix: "※2", class: ["textlink"],},
      ...
      {type: "p", text: `Sound Tracesはまだ未知数だが、「再現から合成へ」という、前林の議論を出発点に考えてきたテーマと強く結びつく予感があり、しばらく続けてみたいと思っている。協力者からの投稿の中には、当初想定していなかった発見もあり、進めながら見えてくるものが多そうだ。`},
